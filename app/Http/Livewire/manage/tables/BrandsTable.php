...
use PowerComponents\LivewirePowerGrid\Rules\Rule;
 ...
 class BrandsTable extends PowerGridComponent
{
    use ActionButton;
    ...
    */
    public function addColumns(): ?PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('updated_at_formatted', function(Brand $model) {
...
;
    ...
    */
    ...
    {
        error_log('Updated brands');
       try {
           $updated = Brand::query()->findOrFail($data['id'])
                ->update([
